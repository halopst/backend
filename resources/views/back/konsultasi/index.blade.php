...
{{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.0/css/bootstrap.min.css"> --}}
    ...
    <style>
        ...
        #dataTable {
          /*table-layout: fixed !important; /* paksa patuhi lebar kolom */
          width: 100% !important;
        }
     ...
     $(document).ready(function(){
        $('#dataTable').DataTable({
            ...
            columns: [
              ...
              { data:'tanggal_konsultasi', name:'tanggal_konsultasi', width:'10%' },
              { data:'waktu_konsultasi', name:'waktu_konsultasi', className:'text-center', width:'8%' },
              { data:'id_satker', name:'id_satker', className:'text-center', width:'10%' },
              { data:'topik_diskusi', name:'topik_diskusi', className:'text-wrap', width:'25%' },
              { data:'id_petugas', name:'id_petugas', width:'15%' },
              { data:'id_pengguna', name:'id_pengguna', width:'15%' },
              { data:'status', name:'status', className:'text-center', width:'7%' },
              { data:'aksi', name:'aksi', className:'text-center', width:'5%' }
            ]
        })
      })
