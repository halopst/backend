@foreach ($satker as $item)
  <div class="modal fade" id="modalUpdate{{$item->id_satker}}" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog">
        <form action="{{ url('satker/'.$item->id_satker)}}" method="POST" class="modal-content">
          @method('PUT')
          @csrf
          <div class="modal-header">
            <h5 class="modal-title" id="backDropModalTitle">Update Satuan Kerja</h5>
            <button
              type="button"
              class="btn-close"
            ...
            <div class="row">
              <div class="col mb-3">
                ...
                <input
                  ...
                  value="{{old('id_satker', $item->id_satker)}}"
